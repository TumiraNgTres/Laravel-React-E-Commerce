...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // variation value - color options - blue, red, green
        ...
        // variations added for each product -
        // color: blue (1), red (2), green (3)
        // size: small (4), medium (5), large (6)
        // variation combinations added by vendor - eg:
        // {1, 4}, {1, 5}, {1, 6}
        ...
        Schema::create('product_variations', function (Blueprint $table) {
            ...
            $table->json('variation_type_option_ids')
                ->nullable()
                ->comment('JSON array of variation type option IDs');
